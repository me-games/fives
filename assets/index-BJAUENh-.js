...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Vs(e,t,n){let r=new Float32Array(Ds),i=new H(0,1,0);return new Da({name:`SphericalGaussianBlur`,defines:{n:Ds,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hs(){return new Da({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Ws(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Us(){return new Da({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ws(),fragmentShader:`
	...
	`}var Gs=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ra(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;var Kd=Wd(`#game`),qd=Wd(`#blue-score`),Jd=Wd(`#red-score`),Yd=Wd(`#round-label`),Xd=Wd(`#clock`),Zd=Wd(`#status`),Qd=Wd(`#restart`),$d=new In;$d.background=new K(9685503),$d.fog=new Fn(9685503,65,145);var ef=new Co(50,window.innerWidth/window.innerHeight,.1,260);ef.position.set(-17,17,20);var tf=new ku({canvas:Kd,antialias:!0});tf.setPixelRatio(Math.min(window.devicePixelRatio,2)),tf.setSize(window.innerWidth,window.innerHeight),tf.outputColorSpace=Be,tf.toneMapping=4,tf.toneMappingExposure=1,tf.shadowMap.enabled=!0,tf.shadowMap.type=1;var nf=new Vo;nf.connect(document);var rf=new Jo;ef.add(rf);var af=new co,of=new Nu,sf=new Io,cf={},lf=new Set,uf=null,df=new H,ff=new H,pf=new H,mf=new ls,hf=new ji(new H(0,1,0),0),gf=new H,_f=new V,vf=new H,yf=new H,bf=new Set,xf=!1,Sf=!1,Cf=!1,wf=!1,Z={phase:`kickoff`,blueScore:0,redScore:0,round:1,timeLeft:Bd,kickoffTimer:1.4},Q={field:new ka({color:3046706,roughness:.92}),fieldStripe:new ka({color:3642436,roughness:.94}),fieldDark:new ka({color:1924910,roughness:.96}),line:new ka({color:15988719,roughness:.7}),blue:new ka({color:1924607,roughness:.48,metalness:.02}),blueTrim:new ka({color:12113151,roughness:.58}),red:new ka({color:14232877,roughness:.5,metalness:.02}),redTrim:new ka({color:16762556,roughness:.6}),skin:new ka({color:14262895,roughness:.64}),black:new ka({color:1118999,roughness:.62}),ball:new ka({color:16316654,roughness:.43}),ballInk:new ka({color:1579551,roughness:.58}),goal:new ka({color:16250866,roughness:.42}),net:new Ii({color:14477551,transparent:!0,opacity:.46}),selector:new Wr({color:16241480,transparent:!0,opacity:.86}),stand:new ka({color:3817029,roughness:.78}),seatBlue:new ka({color:2321367,roughness:.8}),seatRed:new ka({color:12533310,roughness:.8}),seatLight:new ka({color:14870504,roughness:.82}),audienceBlue:new ka({color:2981344,roughness:.7}),audienceRed:new ka({color:14108989,roughness:.72}),audienceYellow:new ka({color:15190080,roughness:.72}),audienceWhite:new ka({color:15331056,roughness:.74}),treeTrunk:new ka({color:7293486,roughness:.88}),treeLeaf:new ka({color:3115589,roughness:.92}),treeLeafDark:new ka({color:2059833,roughness:.94}),shadowOnly:new va({color:0,opacity:.2})};function Tf(){rf.context.state===`suspended`?rf.context.resume().then(Df):Df()}function Ef(e,t){sf.load(t,t=>{cf[e]=t,e===`music`&&Df()},void 0,t=>{console.warn(`Could not load ${e} sound`,t)})}function Df(){let e=cf.music;!e||rf.context.state!==`running`||(uf||(uf=new Yo(rf),uf.setBuffer(e),uf.setLoop(!0),uf.setVolume(.22)),uf.isPlaying||uf.play())}function Of(e,t=.75){let n=cf[e];if(!n||rf.context.state!==`running`)return;let r=new Yo(rf),i=r.onEnded.bind(r);r.onEnded=()=>{i(),r.disconnect(),lf.delete(r)},r.setBuffer(n),r.setVolume(t),lf.add(r),r.play()}function kf(){af.load(Hd.turfTexture,e=>{e.colorSpace=Be,e.wrapS=t,e.wrapT=t,e.repeat.set(18,12),e.anisotropy=tf.capabilities.getMaxAnisotropy();let n=e.clone();n.needsUpdate=!0,Q.field.map=e,Q.field.color.set(16777215),Q.field.needsUpdate=!0,Q.fieldStripe.map=n,Q.fieldStripe.color.set(14152656),Q.fieldStripe.needsUpdate=!0},void 0,e=>{console.warn(`Could not load generated turf texture`,e)})}function Af(){of.load(Hd.ballModel,e=>{let t=e.scene;t.traverse(e=>{e instanceof q&&(e.castShadow=!0,e.receiveShadow=!1)});let n=new Zn().setFromObject(t),r=n.getSize(new H),i=Math.max(r.x,r.y,r.z);if(i>0){t.scale.setScalar(Rd*2/i),t.updateWorldMatrix(!0,!0),n.setFromObject(t);let e=n.getCenter(new H);t.position.sub(e)}$.clear(),$.add(t)},void 0,e=>{console.warn(`Could not load generated football model`,e)})}function jf(e,t){e.updateWorldMatrix(!0,!0);let n=new Zn().setFromObject(e),r=n.getSize(new H),i=Math.max(r.y,.001);e.scale.multiplyScalar(t/i),e.updateWorldMatrix(!0,!0),n.setFromObject(e);let a=n.getCenter(new H),o=n.min.y;return e.position.x-=a.x,e.position.y-=o,e.position.z-=a.z,e.updateWorldMatrix(!0,!0),e}function Mf(e,t){return jf(e,t),e.traverse(e=>{e instanceof q&&(e.castShadow=!0,e.receiveShadow=!0)}),e}function Nf(e,t){e.visualModel&&e.group.remove(e.visualModel);let n=ju(t);n.rotation.y=Math.PI,n.position.y=0,n.scale.multiplyScalar(e.controlled?1.04:1),e.fallbackGroup.visible=!1,e.visualModel=n,e.group.add(n)}function Pf(){of.load(Hd.bluePlayerModel,e=>{let t=Mf(e.scene,2.65);for(let e of Gf)Nf(e,t)},void 0,e=>{console.warn(`Could not load generated blue player model`,e)}),of.load(Hd.redPlayerModel,e=>{let t=Mf(e.scene,2.65);for(let e of Kf)Nf(e,t)},void 0,e=>{console.warn(`Could not load generated red player model`,e)})}function Ff(){af.load(Hd.stadiumSkybox,e=>{e.mapping=303,e.colorSpace=Be,$d.background=e,$d.environment=new Is(tf).fromEquirectangular(e).texture,tf.toneMappingExposure=1.05},void 0,e=>{console.warn(`Could not load generated stadium skybox`,e)})}function If(){of.load(Hd.fanModel,e=>{let t=Mf(e.scene,1.35);Vf.clear(),$f.forEach((e,n)=>{if(n%13!=0)return;let r=ju(t);r.position.copy(e.position),r.position.y-=.08,r.rotation.y=e.rotationY+Math.PI,r.scale.setScalar(e.scale*(.9+n%5*.035)),Vf.add(r)})},void 0,e=>{console.warn(`Could not load generated spectator model`,e)})}function Lf(){of.load(Hd.treeModel,e=>{let t=Mf(e.scene,5.9);Uf.clear(),ep.forEach((e,n)=>{if(n%3!=0)return;let r=ju(t);r.position.copy(e.position),r.rotation.y=e.rotationY,r.scale.setScalar(e.scale*(.86+n%4*.08)),Uf.add(r)})},void 0,e=>{console.warn(`Could not load generated tree model`,e)})}function Rf(){Ff(),kf(),Af(),Pf(),If(),Lf(),Ef(`kick`,Hd.kickSfx),Ef(`goal`,Hd.goalSfx),Ef(`whistle`,Hd.whistleSfx),Ef(`music`,Hd.musicSfx)}var zf=new Dn,Bf=new Dn,Vf=new Dn,Hf=new Dn,Uf=new Dn,Wf=[],Gf=[],Kf=[],$=new Dn,qf=new H,Jf=new Zn(new H(-82/2,-.1,-52/2),new H(Md/2,5,Nd/2));function Yf(e,t){return 1-Math.exp(-e*t)}function Xf(e,t,n){return Math.min(n,Math.max(t,e))}function Zf(e){let t=e>>>0;return()=>{t+=1831565813;let e=t;return e=Math.imul(e^e>>>15,e|1),e^=e+Math.imul(e^e>>>7,e|61),((e^e>>>14)>>>0)/4294967296}}var Qf=Zf(Vd),$f=[],ep=[];function tp(e,t,n,r,i,a){return{position:new H(e,t,n),rotationY:r,scale:i,variant:a}}function np(e){let t=new ca(.19,.52,4,8),n=new ma(.15,10,8),r=[Q.audienceBlue,Q.audienceRed,Q.audienceYellow,Q.audienceWhite],i=r.map(()=>[]);for(let t of e)i[t.variant%i.length].push(t);let a=new En;i.forEach((e,n)=>{let i=new Di(t,r[n],e.length);i.castShadow=!0,i.receiveShadow=!1,e.forEach((e,t)=>{a.position.copy(e.position),a.position.y+=.45*e.scale,a.rotation.set(0,e.rotationY,0),a.scale.setScalar(e.scale),a.updateMatrix(),i.setMatrixAt(t,a.matrix)}),i.instanceMatrix.needsUpdate=!0,Bf.add(i)});let o=new Di(n,Q.skin,e.length);o.castShadow=!0,e.forEach((e,t)=>{a.position.copy(e.position),a.position.y+=1*e.scale,a.rotation.set(0,e.rotationY,0),a.scale.setScalar(e.scale),a.updateMatrix(),o.setMatrixAt(t,a.matrix)}),o.instanceMatrix.needsUpdate=!0,Bf.add(o)}function rp(){for(let e of[-1,1]){let t=e>0?Math.PI:0;for(let n=0;n<5;n+=1)for(let r=0;r<58;r+=1){if((r+n)%9==0&&n>2)continue;let i=Qf()-.5,a=-82/2-8+98/57*r+i*.28,o=e*(31.45+n*2.18+(Qf()-.5)*.28),s=.9+n*.58,c=.78+Qf()*.22;$f.push(tp(a,s,o,t,c,r+n*3+(e>0?2:0)))}}}function ip(){for(let e of[-1,1]){let t=e>0?-Math.PI/2:Math.PI/2;for(let n=0;n<4;n+=1)for(let r=0;r<22;r+=1){if((r+n)%8==0)continue;let i=e*(47+n*2.1+(Qf()-.5)*.25),a=-21+r*((Nd-10)/21)+(Qf()-.5)*.22,o=.75+n*.52,s=.72+Qf()*.2;$f.push(tp(i,o,a,t,s,r+n*5+(e>0?1:3)))}}}function ap(){Bf.name=`extensive-audience-system`,Vf.name=`generated-featured-fans`,$f.length=0,Bf.clear(),Vf.clear(),rp(),ip(),np($f),Bf.add(Vf),$d.add(Bf)}function op(e){let t=new ua(.18,.28,2.4,7),n=new fa(1.45,1),r=new En,i=new Di(t,Q.treeTrunk,e.length),a=new Di(n,Q.treeLeaf,e.length),o=new Di(n,Q.treeLeafDark,Math.ceil(e.length/2)),s=0;i.castShadow=!0,a.castShadow=!0,o.castShadow=!0,e.forEach((e,t)=>{r.position.copy(e.position),r.position.y+=1.2*e.scale,r.rotation.set(0,e.rotationY,0),r.scale.set(e.scale*.72,e.scale,e.scale*.72),r.updateMatrix(),i.setMatrixAt(t,r.matrix),r.position.copy(e.position),r.position.y+=2.95*e.scale,r.rotation.set(.08*Math.sin(t),e.rotationY,.05*Math.cos(t)),r.scale.set(e.scale*1.25,e.scale*.95,e.scale*1.25),r.updateMatrix(),a.setMatrixAt(t,r.matrix),t%2==0&&(r.position.copy(e.position),r.position.x+=.58*e.scale,r.position.y+=3.24*e.scale,r.position.z-=.44*e.scale,r.rotation.set(.14,e.rotationY+.9,-.08),r.scale.set(e.scale*.86,e.scale*.68,e.scale*.86),r.updateMatrix(),o.setMatrixAt(s,r.matrix),s+=1)}),i.instanceMatrix.needsUpdate=!0,a.instanceMatrix.needsUpdate=!0,o.count=s,o.instanceMatrix.needsUpdate=!0,Hf.add(i,a,o)}function sp(){Hf.name=`perimeter-tree-system`,Uf.name=`generated-tree-line`,ep.length=0,Hf.clear(),Uf.clear();for(let e of[-1,1])for(let t=0;t<30;t+=1){let n=-82/2-12+106/29*t+(Qf()-.5)*2.4,r=e*(42+Qf()*7),i=1.05+Qf()*.58;ep.push(tp(n,0,r,Qf()*Math.PI*2,i,t))}for(let e of[-1,1])for(let t=0;t<18;t+=1){let n=e*(57+Qf()*8),r=-52/2-8+68/17*t+(Qf()-.5)*2,i=.95+Qf()*.55;ep.push(tp(n,0,r,Qf()*Math.PI*2,i,t))}op(ep),Hf.add(Uf),$d.add(Hf)}function cp(e,t=!0,n=!1){e.traverse(e=>{e instanceof q&&(e.castShadow=t,e.receiveShadow=n)})}function lp(e,t,n){let r=new q(new pa(e,t),n);return r.rotation.x=-Math.PI/2,r.receiveShadow=!0,r}function up(e,t,n,r){let i=new q(new sa(n,.045,r),Q.line);return i.position.set(e,.042,t),i.receiveShadow=!0,zf.add(i),i}function dp(e){let t=new q(new ha(e,.055,8,96),Q.line);t.rotation.x=Math.PI/2,t.position.y=.08,zf.add(t)}function fp(e,t,n,r,i){let a=n/2,o=r/2;up(e,t-o,n,.16),up(e,t+o,n,.16),up(i===`left`?e+a:e-a,t,.16,r)}function pp(){zf.name=`field-system`,$d.add(zf);let e=lp(88,58,Q.fieldDark);e.position.y=-.012,zf.add(e);let t=lp(Md,Nd,Q.field);t.position.y=0,zf.add(t);let n=Md/12;for(let e=0;e<12;e+=1)if(e%2==0){let t=lp(n,Nd,Q.fieldStripe);t.position.set(-82/2+n*e+n/2,.006,0),zf.add(t)}up(0,-52/2,Md,.18),up(0,Nd/2,Md,.18),up(-82/2,0,.18,Nd),up(Md/2,0,.18,Nd),up(0,0,.16,Nd),dp(7.2);let r=new q(new la(.34,24),Q.line);r.rotation.x=-Math.PI/2,r.position.y=.09,zf.add(r),fp(-33,0,16,27,`left`),fp(Md/2-8,0,16,27,`right`),fp(-37.2,0,7.6,15.5,`left`),fp(Md/2-3.8,0,7.6,15.5,`right`),hp(`blue`),hp(`red`),gp(),ap(),sp()}function mp(e){let t=[],n=e*41.1,r=e*45.5,i=Pd/2;for(let e=-7;e<=7.01;e+=Pd/6)t.push(new H(n,Id,e),new H(r,.35,e));for(let e=.6;e<=4.01;e+=.75)t.push(new H(r,e,-7),new H(r,e,i));for(let e=-7;e<=7.01;e+=Pd/6)t.push(new H(r,.35,e),new H(r,Id,e));return new Ji(new Ar().setFromPoints(t),Q.net)}function hp(e){let t=e===`red`?1:-1,n=new Dn,r=t*41.18,i=t*45.5,a=(r+i)/2,o=new sa(.34,Id,.34),s=new sa(.34,.34,14.34),c=new sa(Fd,.22,.22);for(let e of[-14/2,Pd/2]){let t=new q(o,Q.goal);t.position.set(r,Id/2,e),n.add(t);let a=new q(o,Q.goal);a.position.set(i,Id/2,e),n.add(a)}let l=new q(s,Q.goal);l.position.set(r,Id,0),n.add(l);let u=new q(s,Q.goal);u.position.set(i,Id,0),n.add(u);for(let e of[-14/2,Pd/2]){let t=new q(c,Q.goal);t.position.set(a,Id,e),n.add(t)}let d=mp(t);n.add(d),cp(n,!0,!1),zf.add(n)}function gp(){let e=new Dn;e.name=`procedural-stand-geometry`;let t=[Q.seatBlue,Q.seatRed,Q.seatLight];for(let n of[-1,1]){for(let t=0;t<5;t+=1){let r=new q(new sa(100,.7,2.6),Q.stand);r.position.set(0,.35+t*.58,n*(31.4+t*2.18)),r.receiveShadow=!0,r.castShadow=!0,e.add(r)}for(let r=0;r<54;r+=1){let i=new q(new sa(1.15,.55,.85),t[(r+ +(n>0))%t.length]);i.position.set(-82/2-8+98/53*r,1.4+Qf()*.5,n*35.6),i.castShadow=!0,e.add(i)}}for(let t of[-1,1])for(let n=0;n<4;n+=1){let r=new q(new sa(2.55,.64,Nd-7),Q.stand);r.position.set(t*(47+n*2.1),.32+n*.52,0),r.receiveShadow=!0,r.castShadow=!0,e.add(r)}$d.add(e)}function _p(){let e=new uo(14544639,3232812,1.8);$d.add(e);let t=new Ao(16774098,3.1);t.position.set(-35,60,26),t.castShadow=!0,t.shadow.mapSize.set(2048,2048),t.shadow.camera.left=-62,t.shadow.camera.right=62,t.shadow.camera.top=48,t.shadow.camera.bottom=-48,t.shadow.camera.near=8,t.shadow.camera.far=112,t.shadow.bias=-8e-5,t.shadow.normalBias=.025,$d.add(t)}function vp(e,t,n,r=!1){let i=new Dn;i.position.copy(n),i.name=`${e}-${t}`;let a=e===`blue`?Q.blue:Q.red,o=e===`blue`?Q.blueTrim:Q.redTrim,s=new Dn;s.name=`fallback-player-capsule`;let c=new q(new ca(.52,1.05,6,14),a);c.position.y=1.35,s.add(c);let l=new q(new sa(.82,.2,.9),o);l.position.y=1.6,s.add(l);let u=new q(new ma(.34,16,12),Q.skin);u.position.y=2.22,s.add(u);let d=new ua(.14,.16,.9,10),f=new q(d,Q.black),p=new q(d,Q.black);f.position.set(0,.46,-.25),p.position.set(0,.46,.25),s.add(f,p),i.add(s);let m=new q(new ha(1.08,.045,8,64),Q.selector);m.rotation.x=Math.PI/2,m.position.y=.055,m.visible=r,i.add(m);let h=new q(new la(.9,24),Q.shadowOnly);return h.rotation.x=-Math.PI/2,h.position.y=.025,h.receiveShadow=!0,i.add(h),cp(i,!0,!1),$d.add(i),{team:e,number:t,controlled:r,group:i,body:c,leftLeg:f,rightLeg:p,selector:m,fallbackGroup:s,home:n,target:n.clone(),velocity:new H,kickCooldown:0,legPhase:Qf()*Math.PI*2}}function yp(){let e=[new H(-24,0,0),new H(-29,0,-12),new H(-29,0,12),new H(-35,0,-7),new H(-35,0,7)],t=e.map(e=>new H(-e.x,0,-e.z));e.forEach((e,t)=>{let n=vp(`blue`,t+1,e,t===0);Wf.push(n),Gf.push(n)}),t.forEach((e,t)=>{let n=vp(`red`,t+1,e);Wf.push(n),Kf.push(n)})}function bp(){let e=new q(new ma(Rd,28,18),Q.ball);e.castShadow=!0,$.add(e);let t=new Ji(new ga(new fa(Rd*1.012,2)),new Ii({color:1118481,transparent:!0,opacity:.32}));$.add(t);for(let e=0;e<8;e+=1){let t=new q(new la(.12,12),Q.ballInk),n=e/8*Math.PI*2;t.position.set(Math.cos(n)*Rd*.96,0,Math.sin(n)*Rd*.96),t.lookAt(t.position.clone().multiplyScalar(2)),$.add(t)}$.position.set(0,Rd,0),$d.add($)}function xp(){Z.phase=`kickoff`,Z.timeLeft=Bd,Z.kickoffTimer=1.4,Zd.textContent=`Round ${Z.round}`,Zd.hidden=!1;for(let e of Wf)e.group.position.copy(e.home),e.velocity.set(0,0,0),e.kickCooldown=0,e.group.lookAt(e.group.position.x+Ud[e.team],0,e.group.position.z);$.position.set(0,Rd,0),qf.set(0,0,0),Sf=!1,wp()}function Sp(){Z.phase=`finished`,Zd.textContent=`${Z.blueScore>Z.redScore?`Blue Wins`:Z.redScore>Z.blueScore?`Red Wins`:`Draw`} ${Z.blueScore}:${Z.redScore}`,Zd.hidden=!1,Qd.hidden=!1}function Cp(e){if(e===`blue`?Z.blueScore+=1:e===`red`&&(Z.redScore+=1),e&&Of(`goal`,.72),Of(`whistle`,.52),Z.round>=zd){wp(),Sp();return}Z.round+=1,xp()}function wp(){qd.textContent=String(Z.blueScore),Jd.textContent=String(Z.redScore),Yd.textContent=`Round ${Z.round}/${zd}`,Xd.textContent=Z.phase===`finished`?`0.0`:Z.timeLeft.toFixed(1)}function Tp(){Z.blueScore=0,Z.redScore=0,Z.round=1,Qd.hidden=!0,xp()}function Ep(e){let t=Kd.getBoundingClientRect();_f.x=(e.clientX-t.left)/t.width*2-1,_f.y=-((e.clientY-t.top)/t.height*2-1),mf.setFromCamera(_f,ef),mf.ray.intersectPlane(hf,gf)&&(gf.x=Xf(gf.x,-39.8,Md/2-1.2),gf.z=Xf(gf.z,-24.8,Nd/2-1.2),gf.y=0,Sf=!0)}function Dp(){return Gf[0]}function Op(){let e=new H;if((bf.has(`KeyW`)||bf.has(`ArrowUp`))&&(e.x+=1),(bf.has(`KeyS`)||bf.has(`ArrowDown`))&&--e.x,(bf.has(`KeyA`)||bf.has(`ArrowLeft`))&&--e.z,(bf.has(`KeyD`)||bf.has(`ArrowRight`))&&(e.z+=1),xf&&Sf){let t=Dp();e.copy(gf).sub(t.group.position),e.y=0,e.lengthSq()<1.3&&e.set(0,0,0)}return e.lengthSq()>0&&e.normalize(),e}function kp(e,t){let n=e.x-t.x,r=e.z-t.z;return Math.hypot(n,r)}function Ap(e,t,n,r){let i=vf.copy(t).multiplyScalar(n);if(e.velocity.lerp(i,Yf(12,r)),e.group.position.addScaledVector(e.velocity,r),e.group.position.x=Xf(e.group.position.x,-40.15,Md/2-Ld),e.group.position.z=Xf(e.group.position.z,-25.15,Nd/2-Ld),e.group.position.y=0,e.velocity.lengthSq()>.08){let t=vf.copy(e.group.position).add(e.velocity);e.group.lookAt(t.x,0,t.z)}let a=e.velocity.length()*r;e.legPhase+=a*4.2;let o=Math.sin(e.legPhase)*Math.min(.6,e.velocity.length()*.08);e.leftLeg.rotation.x=o,e.rightLeg.rotation.x=-o,e.body.position.y=1.35+Math.abs(Math.sin(e.legPhase))*Math.min(.06,e.velocity.length()*.008),e.visualModel&&(e.visualModel.position.y=Math.abs(Math.sin(e.legPhase))*Math.min(.08,e.velocity.length()*.01))}function jp(e,t){let n=e[0],r=1/0;for(let i of e){let e=kp(i.group.position,t);e<r&&(r=e,n=i)}return n}function Mp(e){let t=jp(Gf.slice(1),$.position),n=jp(Kf,$.position);for(let r of Wf){if(r.controlled)continue;let i=Ud[r.team],a=Xf($.position.x*.22,-9,9),o=Xf($.position.z*.16,-5,5),s=r===n||r===t&&kp(Dp().group.position,$.position)>8;if(s?r.target.copy($.position):r.target.set(Xf(r.home.x+a*i,-37,Md/2-4),0,Xf(r.home.z+o,-22,Nd/2-4)),vf.copy(r.target).sub(r.group.position),vf.y=0,vf.length()>.1?vf.normalize():vf.set(0,0,0),Ap(r,vf,s?7.1:5.1,e),kp(r.group.position,$.position)<1.85){let e=i*Md/2;vf.copy($.position).setX(e).setZ($.position.z*.28),vf.sub($.position),vf.y=0,vf.lengthSq()>0&&vf.normalize(),Pp(r,vf,r.team===`red`?18:15)}}}function Np(){for(let e=0;e<Wf.length;e+=1)for(let t=e+1;t<Wf.length;t+=1){let n=Wf[e],r=Wf[t],i=vf.copy(r.group.position).sub(n.group.position);i.y=0;let a=i.length(),o=Ld*1.85;if(a>.001&&a<o){let e=(o-a)*.5;i.normalize().multiplyScalar(e),r.group.position.add(i),n.group.position.sub(i)}}}function Pp(e,t,n){Z.phase!==`playing`||e.kickCooldown>0||kp(e.group.position,$.position)>2.25||(vf.copy(t),vf.y=0,vf.lengthSq()<.001?vf.set(Ud[e.team],0,0):vf.normalize(),qf.addScaledVector(vf,n),qf.clampLength(0,28),$.position.addScaledVector(vf,.28),e.kickCooldown=.32,Of(`kick`,e.controlled?.82:.48))}function Fp(e){let t=Dp(),n=Op(),r=bf.has(`ShiftLeft`)||bf.has(`ShiftRight`);if(Ap(t,n,r?9.6:7.8,e),Cf){let e=yf.copy(n);e.lengthSq()<.001&&Sf&&e.copy(gf).sub(t.group.position),e.lengthSq()<.001&&e.set(1,0,0),Pp(t,e,r?23:19),Cf=!1}}function Ip(){for(let e of Wf){let t=vf.copy($.position).sub(e.group.position);t.y=0;let n=t.length(),r=1.43;if(n>.001&&n<r){let i=r-n;t.normalize(),$.position.addScaledVector(t,i),qf.addScaledVector(t,e.controlled?2.2:1.6)}}}function Lp(e){$.position.addScaledVector(qf,e),qf.multiplyScalar(Math.exp(-1.55*e)),qf.lengthSq()<.006&&qf.set(0,0,0),$.position.y=Rd,$.rotation.z-=qf.x*e/Rd,$.rotation.x+=qf.z*e/Rd,$.position.z<-25.42?($.position.z=-25.42,qf.z=Math.abs(qf.z)*.68):$.position.z>Nd/2-Rd&&($.position.z=Nd/2-Rd,qf.z=-Math.abs(qf.z)*.68);let t=Math.abs($.position.z)<Pd/2;if($.position.x>43.025&&t){Cp(`blue`);return}if($.position.x<-82/2-Fd*.45&&t){Cp(`red`);return}$.position.x>Md/2-Rd&&!t?($.position.x=Md/2-Rd,qf.x=-Math.abs(qf.x)*.62):$.position.x<-40.42&&!t&&($.position.x=-40.42,qf.x=Math.abs(qf.x)*.62)}function Rp(e){let t=Dp();pf.lerpVectors(t.group.position,$.position,.32),pf.y=1.1,ff.copy(pf),ff.add(new H(-15,16,18)),ef.position.lerp(ff,Yf(4.8,e)),df.lerp(pf,Yf(6.2,e)),ef.lookAt(df)}function zp(e){if(Z.phase!==`finished`){if(Z.phase===`kickoff`){Z.kickoffTimer-=e,Z.kickoffTimer<=0&&(Z.phase=`playing`,Zd.hidden=!0,Of(`whistle`,.48));return}Z.timeLeft=Math.max(0,Z.timeLeft-e),Z.timeLeft<=0&&Cp()}}function Bp(e){wf=e,zf.traverse(t=>{if(t instanceof q){let n=Array.isArray(t.material)?t.material:[t.material];for(let t of n){let n=t;typeof n.wireframe==`boolean`&&(n.wireframe=e)}}}),Jf.getCenter(vf)}function Vp(e){let t=Math.min(e,.05);for(let e of Wf)e.kickCooldown=Math.max(0,e.kickCooldown-t);zp(t),Z.phase!==`finished`&&(Fp(t),Mp(t),Np(),Ip(),Lp(t)),Rp(t),wp()}function Hp(e){nf.update(e),Vp(nf.getDelta()),tf.render($d,ef),requestAnimationFrame(Hp)}function Up(){let e=window.innerWidth,t=window.innerHeight;ef.aspect=e/t,ef.updateProjectionMatrix(),tf.setSize(e,t),tf.setPixelRatio(Math.min(window.devicePixelRatio,2))}window.addEventListener(`resize`,Up),window.addEventListener(`keydown`,e=>{Tf(),bf.add(e.code),e.code===`Space`&&(e.preventDefault(),Cf=!0),e.code===`Backquote`&&Bp(!wf),e.code===`KeyR`&&Z.phase===`finished`&&Tp()}),window.addEventListener(`keyup`,e=>{bf.delete(e.code)}),Kd.addEventListener(`pointerdown`,e=>{Tf(),xf=!0,Ep(e),Kd.setPointerCapture(e.pointerId),e.detail>1&&(Cf=!0)}),Kd.addEventListener(`pointermove`,e=>{xf&&Ep(e)}),Kd.addEventListener(`pointerup`,e=>{xf=!1,Kd.releasePointerCapture(e.pointerId)}),Kd.addEventListener(`pointercancel`,()=>{xf=!1}),Qd.addEventListener(`click`,()=>{Tf(),Tp()}),_p(),pp(),yp(),bp(),Rf(),xp(),Up(),requestAnimationFrame(Hp);